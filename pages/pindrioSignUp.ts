...
export class pindrioSignUpPage {
    ...
    async goto() {
        await this.page.goto('https://ioto-marketplace.semiotic.eu/account/register');
    }

    async signUp(ctx: TestContext) {
        try {
            await this.goto();
            ...
            await this.phoneTextBox.fill(ctx.phone);
            ...
            await this.confirmPasswordTextBox.fill(ctx.password);
